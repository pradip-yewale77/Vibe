...
import { FiHome, FiGrid, FiFileText, FiUser, FiLogOut, FiSettings, FiPlus } from "react-icons/fi"
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        {/* Desktop Navigation - Fixed alignment issue */}
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent className="rounded-xl shadow-xl border border-gray-100 dark:border-zinc-800 overflow-hidden">
                  <div className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-2">
                    <div className="row-span-3 flex flex-col justify-center p-6 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-zinc-800 dark:to-zinc-900 rounded-lg">
                      <div className="mt-4 mb-2 text-lg font-medium flex items-center">
                        <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-2">V</span>
                        Template Gallery
                      </div>
                      <p className="text-muted-foreground text-sm mb-4">
                        Beautiful, production-ready templates to kickstart your projects
                      </p>
                      <Button size="sm" className="mt-2" onClick={() => router.push("/templates")}>
